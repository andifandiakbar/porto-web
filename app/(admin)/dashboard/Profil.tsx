        ...
        <table style={{...tableStyle, width: '100%', tableLayout: 'fixed' }}>
          ...
          <tbody>
            {pejabat.length > 0 ? (
                    ...
                    {editId === item.id ? (
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                          <label style={{ fontSize: '10px', fontWeight: '700', color: '#64748b', fontFamily: '"Arial"', letterSpacing: '-0.1px' }}>Ganti / Hapus Foto:</label>
                          <input type="file" accept="image/*" onChange={(e) => handleFileUpload(e, true)} style={{ fontSize: '11px', fontFamily: '"Arial"' }} />
                          
                          {tempData.foto && (
                            <button 
                              onClick={() => setTempData({...tempData, foto: ''})} 
                              style={{ border: 'none', background: 'none', color: '#E53E3E', fontSize: '11px', cursor: 'pointer', textAlign: 'left', padding: 0, fontWeight: '700', fontFamily: '"Arial"', letterSpacing: '-0.1px' }}
                            >
              ...
              <tr>
                <td colSpan={5} style={{ textAlign: 'center', padding: '60px 20px', color: '#A0AEC0', fontSize: '14px', letterSpacing: '-0.2px' }}>Data tidak ditemukan</td>
              </tr>
            )}
          </tbody>
        </table>
...
const thStyle = { padding: '18px 15px', textAlign: 'left' as 'left', fontSize: '11px', fontWeight: '700', color: '#718096', letterSpacing: '0.5px', fontFamily: '"Arial"' };
const tdStyle = { padding: '15px', fontSize: '14px', borderBottom: '1px solid #F1F5F9', fontFamily: '"Arial"' };
...
const editInputStyle = { width: '100%', padding: '6px 10px', borderRadius: '6px', border: '2px solid #093b77', outline: 'none', fontSize: '13px', fontFamily: '"Arial"', letterSpacing: '-0.2px' };
const badgeStyle = { padding: '4px 10px', borderRadius: '6px', backgroundColor: '#EBF8FF', color: '#2B6CB0', fontSize: '12px', fontWeight: '700', fontFamily: '"Arial"', letterSpacing: '-0.1px' };
const btnEditInline = { border: '1px solid #E2E8F0', background: 'white', padding: '6px 12px', borderRadius: '8px', cursor: 'pointer', fontWeight: '700', fontSize: '12px', transition: 'all 0.2s', fontFamily: '"Arial"', letterSpacing: '-0.1px' };
const btnDeleteInline = { border: '1px solid #FED7D7', background: '#FFF5F5', padding: '6px 12px', borderRadius: '8px', cursor: 'pointer', fontWeight: '700', fontSize: '12px', transition: 'all 0.2s', fontFamily: '"Arial"', letterSpacing: '-0.1px' };